  ...
  return (
    <Container>
      ...
      <ContentContainer>
        ...
        ></TimeTable>
        <Sidebar>
          <DailyGraph graphRatio={graphRatio}></DailyGraph>
          {isTimeEditOn ? (
            <TodoListEditMode></TodoListEditMode>
          ) : (
            <DailyTodoList dailyAllTodo={dailyAllTodo} toGetWorkId={toGetWorkId} toGetRestId={toGetRestId} getTimeId={getTimeId}/>
          )}
          <DailyRetrospect memo={memo} setMemo={setMemo} todayId={todayId}></DailyRetrospect>
        </Sidebar>
      </ContentContainer>
...
export default DailyWorkationCom;
